...
%      par - parameters (if any) for the function with right hand side of
%            extended ODE-system.
%
%    Output parameters:
%      Texp - time values
...
%
%    Example. Lorenz system (see file lorenz_ext.m):
%               dx/dt = sigma*(y - x)     = f1
%               dy/dt = r*x - y - x*z = f2
%               dz/dt = x*y - b*z     = f3
%
...
% Solution of extended ODE system 
  ...
  options = odeset;
  [T,Y] = feval(fcn_integrator,rhs_ext_fcn,[t t+stept],y,options,par);  
