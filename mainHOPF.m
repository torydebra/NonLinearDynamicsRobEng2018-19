...
disp(' ');
disp(['COMMENTO: E'' stata trovata due biforcazioni hopf per p1 = ',num2str(xE(4,sE(2).index)),'e p1 = ',num2str(xE(4,sE(3).index))]);
...
x1=xE(1:3,sE(4).index);
params(1)=xE(4,sE(4).index);
